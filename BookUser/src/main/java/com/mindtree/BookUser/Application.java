...
public class Application implements Helping
{
	...
	public static void main(String[] args) {
		...
		User user1 = new User(1, "Varnita", 60000, 22);
		User user2 = new User(2, "Sourayan", 44000, 22);
		User user3 = new User(3, "Rajdeep", 51000, 65);
		User user4 = new User(4, "Sunetra", 49000, 22);
